...
const DEMO_ORDERS = [
  { id: 1, buyer: 'Sarah Johnson', site: 'techinsider.com', publisher: 'Mike Owner', type: 'content_placement', price: 95, status: 'completed', created_at: '2026-08-01' },
  { id: 2, buyer: 'Digital Growth Agency', site: 'healthwise.org', publisher: 'Mike Owner', type: 'writing_placement', price: 92, status: 'in_progress', created_at: '2026-08-03' },
  { id: 3, buyer: 'TechBrand Inc', site: 'financepulse.com', publisher: 'Mike Owner', type: 'link_insertion', price: 80, status: 'task_review', created_at: '2026-08-05' },
  { id: 4, buyer: 'Sarah Johnson', site: 'travelvista.com', publisher: 'Lisa Blogs', type: 'content_placement', price: 65, status: 'completed', created_at: '2026-08-07' },
  { id: 5, buyer: 'TechBrand Inc', site: 'bizgrowth.com', publisher: 'Lisa Blogs', type: 'writing_placement', price: 52, status: 'acceptance', created_at: '2026-08-09' },
];
